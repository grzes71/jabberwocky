"""Okno dialogowe wyboru i konfiguracji ścieżek do zasobów (objects, colors, charset) dla Object Studio."""

from pathlib import Path
from typing import Optional, Tuple
from PySide6.QtWidgets import (
    QDialog, QVBoxLayout, QGridLayout, QLabel, 
    QLineEdit, QPushButton, QFileDialog, QDialogButtonBox, QMessageBox, QWidget
)
...
class ResourceDialog(QDialog):
    def __init__(
        ...
        self.setWindowTitle("Konfiguracja zasobów projektu — Object Studio")
        self.resize(560, 200)
